...
const CHAT_BUBBLES = [
    { type: "incoming", text: "Hi! I saw your ad. What's the pricing for your product?", time: "10:31 AM" },
    { type: "outgoing", text: "Thanks for reaching out! 👋 Our Basic plan starts at ₹999/mo. Want to see a demo?", time: "10:31 AM" },
    { type: "incoming", text: "Yes please! When can we schedule?", time: "10:32 AM" },
    { type: "outgoing", text: "✅ Booked you for tomorrow 11 AM. A calendar invite is on its way!", time: "10:32 AM" },
                ...
                <div className="it-wacrm-grid">
                    ...
                    <div className="it-wacrm-text">
                        <div className="it-wacrm-eyebrow">
                            <span style={{ display: "inline-flex", alignItems: "center", marginRight: "0.2rem" }}><FaWhatsapp /></span> Flagship Product
                        </div>
                        ...
                        <div>
                            <div className="it-phone-mockup">
                                ...
                                <div className="it-phone-header">
                                    <span className="it-phone-header-icon"><FaWhatsapp /></span>
                                    ...
                                    {CHAT_BUBBLES.map((bubble, i) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                alignItems: bubble.type === "outgoing" ? "flex-end" : "flex-start",
