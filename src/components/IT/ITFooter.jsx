...
const CONTACT_ITEMS = [
    ...
    { icon: <FaEnvelope />, text: "it@minaa.co.in", href: "mailto:it@minaa.co.in" },
            ...
            <div className="it-container">
                    ...
                    <div>
                        <div className="it-footer-logo-wrap">
                            ...
                            <div>
                                ...
                                <span className="it-footer-brand-sub">Technology Solutions</span>
                            </div>
                        </div>
                        ...
                        <Link
                            ...
                            onMouseLeave={(e) => (e.target.style.color = "var(--it-text-dim)")}
                        >
                            ...
                            {CONTACT_ITEMS.map((item, i) => (
                                <li key={i} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                                    ...
                                    {item.href ? (
                                        ...
                                        <span style={{ color: "var(--it-text-dim)", fontSize: "0.85rem" }}>
                                            {item.text}
                                        </span>
                                    )}
                                </li>
                ...
                <div className="it-footer-bottom">
                    <p className="it-footer-copy">
                        © {currentYear} Minaal IT Solutions. Part of Minaal Group. All rights reserved.
                    </p>
                    <div style={{ display: "flex", gap: "1.5rem" }}>
                        <Link to="/privacy-policy" style={{ color: "var(--it-text-dim)", fontSize: "0.78rem", fontFamily: "var(--it-font-mono)", textDecoration: "none" }}>
                            Privacy Policy
                        </Link>
                        <Link to="/terms" style={{ color: "var(--it-text-dim)", fontSize: "0.78rem", fontFamily: "var(--it-font-mono)", textDecoration: "none" }}>
                            Terms
                        </Link>
                    </div>
                </div>
