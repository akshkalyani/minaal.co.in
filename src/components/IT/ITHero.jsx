        ...
        const ctx = gsap.context(() => {
            ...
            stepsRef.current.forEach((step, i) => {
                ...
                if (i < stepsRef.current.length - 1) {
                    tl.to(
                        step,
                        { opacity: 0, y: -70, filter: "blur(12px)", duration: 1, ease: "power2.in" },
                        "+=0.6"
                    );
                }
            });
            ...
            <section className="it-section-hero" id="it-hero">
                <div className="it-hero-text-wrap">
                    ...
                    <h1 className="it-hero-title">
                        ...
                        <br />
                        With{" "}
                        <span className="it-hero-title-accent">Next‑Gen</span>
                        <br />
                        Technology
                    </h1>
                    ...
                    <p className="it-hero-subtitle">
                        ...
                        digital infrastructure that scales with your ambition. Proudly
                        made for Indian businesses.
                    </p>

                    <div className="it-hero-actions">
                        <button className="it-btn-primary" onClick={() => scrollTo("it-cta")}>
                            <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                <path d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                            Start Your Project
                        </button>
                        <button className="it-btn-secondary" onClick={() => scrollTo("it-services")}>
                            Explore Services →
                        </button>
                    </div>
                </div>
                ...
                <div className="it-hero-stats">
                    {STATS.map((stat, i) => (
                        <div className="it-stat-card" key={i} style={{ animationDelay: `${i * 0.12}s` }}>
