    ...
    <div className="it-container">
      <div className="it-cta-inner">
        ...
        <p className="it-cta-desc">
          Book a free 30-minute discovery call. Our technology consultant will
          map out the perfect solution stack for your business — no obligations,
          no fluff.
        </p>
        ...
        <div className="it-cta-actions">
          ...
          >
            <FaWhatsapp style={{ fontSize: "1.2rem", marginRight: "0.2rem" }} />{" "}
            WhatsApp Us
          </a>
